...
- **112 个 MCP Tool**：覆盖通用查询、网格查询、制造管理、建造规划、标记、存储/种植、研究控制、殖民者管理、医疗、战斗、右键操作、搜索、任务/记忆/计划/意识形态等类别
...
- **领域知识 Skill 系统**：11 个领域知识（基地建造、殖民地管理、战斗准备、装备制造/优化、医疗、研究、角色交互、资源物流、贸易、任务管理）
