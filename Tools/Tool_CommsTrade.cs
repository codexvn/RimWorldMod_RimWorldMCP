...
{
    public class Tool_CommsTrade : ITool
    {
        public string Name => "trade_with_faction";
        public string Description => "通过通讯台与指定派系贸易。小人走到通讯台后打开派系对话，再用 get_open_dialogs + select_dialog_option 选择交易。";
        ...
        public async Task<ToolResult> ExecuteAsync(JsonElement? args)
        {
            ...
            return await CommsHelper.Execute(factionName, colonistId, "易");
        }
